...
function init(){
    ...
    var st = new $jit.ST({
        ...
        onCreateLabel: function(label, node){//树状图的节点样式
            label.id = node.id;            
            label.innerHTML = '<table class=\"table\"><tr><th><span class=\"pull-left\">'+node.name+'</span><span class=\"caret pull-right\"></span></th></tr><tr><td><div class=\"media\"><div class=\"media-left\"><img class=\"media-object\" src=\"./img/employee/'+node.data.photo+'\"/></div><div class=\"media-body\"><h4 class=\"media-heading\">'+node.data.userName+'</h4>职位</div></td></tr></table>';
